package com.myplace.myplace.config;

import com.myplace.myplace.jwt.JwtAuthFilter;
import com.myplace.myplace.jwt.JwtUtil;
import com.myplace.myplace.security.CustomAuthenticationEntryPoint;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/members/signup", "/api/members/login").permitAll()
